...
class UsersManager(models.Manager):
    def register_validator(self, postData):
        ...
        elif len(postData['confirm_password']) < 3:
        ...
        if len(outcome[0]) < 1:
            outcome[1] = Users.objects.create(email=postData['email'].upper(), password=bcrypt.hashpw(postData['password'].encode(), bcrypt.gensalt()).decode(),
